...
export default QUnit.module( 'Objects', () => {
	...
	QUnit.module( 'Mesh', () => {
		...
		QUnit.test( 'raycast', ( assert ) => {
			...
			raycaster.ray.origin.set( 0.25, 0.2, 1 );
			...
			assert.equal( intersection.face.a, 2, 'intersection face a index' );
			assert.equal( intersection.face.b, 3, 'intersection face b index' );
			assert.equal( intersection.face.c, 1, 'intersection face c index' );
			assert.equal( intersection.face.materialIndex, 0, 'intersection face material index' );
			assert.deepEqual( intersection.face.normal, new Vector3( 0, 0, 1 ), 'intersection face normal' );
			assert.deepEqual( intersection.point, new Vector3( 0.25, 0.2, 0 ), 'intersection point' );
			assert.deepEqual( intersection.uv, new Vector2( 0.75, 0.7 ), 'intersection uv' );
